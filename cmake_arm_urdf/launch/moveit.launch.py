...
def generate_launch_description():
    ...
    moveit_config = (
        MoveItConfigsBuilder(
            "low-cost-arm", package_name="cmake_arm_urdf"
        )
        .robot_description(mappings=launch_arguments)
        .trajectory_execution(file_path="config/low-cost-arm.yaml")
    ...
    rviz_config = PathJoinSubstitution(
        [FindPackageShare("cmake_arm_urdf"), "launch", rviz_base]
    )
